	...
	private void initialize() throws InterruptedException {
	    ...
	    listaUsuarios.addListSelectionListener(new ListSelectionListener() {
	    	public void valueChanged(ListSelectionEvent arg0) {
	    		...
	    		datoIP.setText("IP: "+ Main.listaBlanca.get(index).getIP());
	    		datoMAC.setText("MAC: "+ Main.listaBlanca.get(index).getMAC());
	    		LinkedList<Mensaje> enviados = Main.buscarEnListaEnviados(Main.listaBlanca.get(index).getIP());
	    		LinkedList<Mensaje> recibidos = Main.buscarEnListaRecibidos(Main.listaBlanca.get(index).getIP());
